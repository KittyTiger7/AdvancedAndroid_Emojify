...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        Bitmap resultBitmap = detectFacesAndOverlayEmoji(context, picture);
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                switch (whichEmoji(face)) {
                    case SMILE:
                        ...
                        break;
                    case FROWN:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.frown);
                        break;
                    case LEFT_WINK:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.leftwink);
                        break;
                    case RIGHT_WINK:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.rightwink);
                        break;
                    case LEFT_WINK_FROWN:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.leftwinkfrown);
                        break;
                    case RIGHT_WINK_FROWN:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.rightwinkfrown);
                        break;
                    case CLOSED_EYE_SMILE:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.closed_smile);
                        break;
                    case CLOSED_EYE_FROWN:
                        emojiBitmap = BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.closed_frown);
                        break;
                        default:
                            emojiBitmap = null;
                ...
                addBitmapToFace(resultBitmap, emojiBitmap, face);
            }
        }
